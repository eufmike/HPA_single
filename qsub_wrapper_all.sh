...
#$ -l gpu_card=1
#$ -j y
#$ -o /dlab/ldrive/CBT/USLJ-DSDE_DATA-I10008/shihch3/projects/HPA_single_data/qsub_log/output.txt
#$ -e /dlab/ldrive/CBT/USLJ-DSDE_DATA-I10008/shihch3/projects/HPA_single_data/qsub_log/errors.txt
# UGE PARAMETERS END
